function Devices() {
    ...
    _this.setFilters = function(filters) {
        _this.setFiltersList(filters.filter_sidebar ? filters : null);
        _this.setFiltersMap(filters.filter_map ? filters : null);
    };

    _this.setFiltersList = function(filters) {
        _this.filtersList = filters;

        _this.list();
    };

    _this.setFiltersMap = function(filters) {
        _this.filtersMap = filters;

        items = [];

        _this.load(app.urls.devicesMap, _this.filtersMap);
    };

    _this.getFiltersMap = function() {
        return _this.filtersMap;
    }
