        ...
        switch (parameter) {
            ...
            case 'streetview':
                ...
                if (app.settings.streetViewFrame){
                    _text = '<iframe frameborder="0" style="width:290px;height:125px;" data-src="'+app.urls.streetViewFrame+'?size='+data.size+'&amp;location='+_lat+','+_lng+'&amp;heading='+_course+'" data-streetview="'+app.urls.streetView+'?size='+data.size+'&amp;location='+_lat+','+_lng+'&amp;heading='+_course+'"></iframe>';
                }else{
