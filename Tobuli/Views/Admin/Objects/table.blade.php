                ...
                @foreach ($collection as $item)
                    <tr>
                        ...
                        <td style="text-align: center">
                            <span class="device-status" style="background-color: {{ $item->getStatusColor() }}"
                                data-toggle="tooltip" title="{{ trans("global.{$item->getStatus()}") }}">
                            </span>
                        </td>
                        <td>
                        ...
                        @endif
                        <td class="user-list" title="{{ $item->users_list }}">
                            {{ $item->users_list }}
                        </td>
                        <td class="actions">
                            <div class="btn-group dropdown droparrow" data-position="fixed">
                                ...
                                <ul class="dropdown-menu">
                                    ...
                                    @if (Auth::User()->perm('devices', 'view'))
                                        <li>
                                            <a href="{{ route('devices.follow_map', [$item->id]) }}"
                                                onClick="dialogWindow(event, '{{ $item->name }}');">
                                                {{ trans('front.follow') }}
                                            </a>
                                        </li>
                                    @endif
                                    @if (Auth::User()->perm('devices', 'view'))
                                        <li>
                                            <a href="javascript:" data-modal="device_positions_backups"
