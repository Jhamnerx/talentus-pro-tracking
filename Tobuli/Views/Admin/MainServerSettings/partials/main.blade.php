<div class="panel panel-default">
    ...
    <div class="panel-body">
        ...
        <div class="map-setting map-setting-28 map-setting-29 map-setting-30">
            <div class="form-group">
                {!! Form::label('azure_maps_key', trans('validation.attributes.azure_maps_key'), ['class' => 'col-xs-12 col-sm-4 control-label"']) !!}
                <div class="col-xs-12 col-sm-8">
                    {!! Form::text('azure_maps_key', settings('main_settings.azure_maps_key'), ['class' => 'form-control']) !!}
                </div>
            </div>
        </div>
        ...
        <div class="form-group">
            {!! Form::label('expire_notification[channels]', trans('admin.expire_notification_sending_channels'), ['class' => 'col-xs-12 col-sm-4 control-label"']) !!}
            <div class="col-xs-12 col-sm-4">
                <div class="checkbox-inline">
                    {!! Form::hidden('expire_notification[channels][email]', 0) !!}
                    {!! Form::checkbox('expire_notification[channels][email]', 1, $settings['expire_notification']['channels']['email']) !!}
                    {!! Form::label(null, trans('validation.attributes.email')) !!}
                </div>
                <div class="checkbox-inline">
                    {!! Form::hidden('expire_notification[channels][sms]', 0) !!}
                    {!! Form::checkbox('expire_notification[channels][sms]', 1, $settings['expire_notification']['channels']['sms']) !!}
                    {!! Form::label(null, trans('validation.attributes.sms')) !!}
                </div>
            </div>
        </div>
        ...
        <div class="form-group" data-disablable="#captcha_provider;hide-disable;recaptcha recaptcha3">
        ...
        @if (config('addon.lbs'))
        <div class="form-group">
            {!! Form::label('lbs[provider]', trans('validation.attributes.lbs') . ' ' . trans('validation.attributes.provider'), ['class' => 'col-xs-12 col-sm-4 control-label']) !!}
            <div class="col-xs-12 col-sm-8">
                {!! Form::select('lbs[provider]', $lbs_providers, settings('main_settings.lbs.provider'), ['class' => 'form-control']) !!}
            </div>
        </div>

        <div class="form-group">
            {!! Form::label('lbs[api_key]', trans('validation.attributes.lbs'). ' ' . trans('validation.attributes.api_key'), ['class' => 'col-xs-12 col-sm-4 control-label"']) !!}
            <div class="col-xs-12 col-sm-8">
                {!! Form::text('lbs[api_key]', settings('main_settings.lbs.api_key'), ['class' => 'form-control']) !!}
            </div>
        </div>
        @endif
                ...
                <div class="input-group">
                    ...
                    <span class="input-group-btn">
                        <a type="button"
                           ...
                           href="{!! route('admin.main_server_settings.firebase.test') !!}"
                        >
                            <i class="fa fa-paper-plane" title="{{ trans('global.send') }}"></i>
                        </a>
                    </span>
                    <span class="input-group-btn">
