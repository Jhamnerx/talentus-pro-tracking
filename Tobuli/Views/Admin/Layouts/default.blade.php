...
<head>
    ...
    <meta name="author" content="desarrollosgps@gmail.com" />
    <meta name="copyright" content="System modified by desarrollosgps@gmail.com. Information to +573187208706" />
    <meta content="width=device-width, initial-scale=1.0" name="viewport" />
    <link rel="shortcut icon" href="{{ Appearance::getAssetFileUrl('favicon') }}" />
    <link rel="stylesheet" type="text/css"
        href="{{ asset_resource('assets/css/' . Appearance::getSetting('template_color') . '.css') }}" />
            ...
            <div class="container-fluid">
                <div class="navbar-header">
                    <button type="button" class="navbar-toggle collapsed" data-toggle="collapse"
                        data-target="#bs-header-navbar-collapse" aria-expanded="false">
                    ...
                    @if (Appearance::assetFileExists('logo'))
                        <a class="navbar-brand" href="javascript:"><img
                                src="{{ Appearance::getAssetFileUrl('logo') }}"></a>
                    @endif
            ...
            <p>
                <span>{{ date('Y') }} &copy; {{ Appearance::getSetting('server_name') }}
                    ...
                    @if (Auth::User()->isAdmin())
                        ...
                        | {{ trans('front.last_update') }}:
                        {{ Formatter::time()->human(CustomFacades\Server::lastUpdate()) }}
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        ...
                        <button class="btn btn-side" data-dismiss="modal"
                            aria-hidden="true">{{ trans('global.cancel') }}</button>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="modal-content">
                ...
                <div class="modal-footer" style="margin-top: 0">
                    <button type="button" value="confirm"
                        class="btn btn-main submit js-confirm-link-yes">{{ trans('admin.confirm') }}</button>
                    <button type="button" value="cancel" class="btn btn-side"
            ...
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <button class="btn default" data-dismiss="modal"
                        aria-hidden="true">{{ trans('global.close') }}</button>
                </div>
            </div>
        </div>
    </div>
