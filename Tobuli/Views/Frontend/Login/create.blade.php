    ...
    <div class="panel">
        ...
        <div class="panel-body">
            ...
            @if (Appearance::assetFileExists('logo-main'))
                <a href="{{ route('home') }}">
                    <img class="img-responsive center-block" src="{{ Appearance::getAssetFileUrl('logo-main') }}"
                        alt="Logo">
                </a>
            @endif
    ...
    @if (Appearance::getSetting('google_play_link') || Appearance::getSetting('apple_store_link'))
        <div class="app-links">
            @if (Appearance::getSetting('google_play_link'))
                <div class="col-xs-6">
                    <a href="{{ Appearance::getSetting('google_play_link') }}" target="_blank"><img
                            src="{{ asset('assets/images/google-play.png') }}" class="img-responsive" /></a>
                </div>
            @endif

            @if (Appearance::getSetting('apple_store_link'))
                <div class="col-xs-6">
                    <a href="{{ Appearance::getSetting('apple_store_link') }}" target="_blank"><img
                            src="{{ asset('assets/images/apple-store.png') }}" class="img-responsive" /></a>
                </div>
            @endif
