...
<div data-disablable="#device_icons_type;hide;arrow">
    <div class="form-group">
        ...
        {!! Form::select(
            'icon_moving',
            $device_icon_colors,
            $item->icon_colors['moving'] ?? settings('device.status_colors.colors.moving'),
            ['class' => 'form-control'],
        ) !!}
    </div>
    <div class="form-group">
        ...
        {!! Form::select(
            'icon_stopped',
            $device_icon_colors,
            $item->icon_colors['stopped'] ?? settings('device.status_colors.colors.stopped'),
            ['class' => 'form-control'],
        ) !!}
    </div>
    <div class="form-group">
        ...
        {!! Form::select(
            'icon_offline',
            $device_icon_colors,
            $item->icon_colors['offline'] ?? settings('device.status_colors.colors.offline'),
            ['class' => 'form-control'],
        ) !!}
    </div>
    <div class="form-group">
        ...
        {!! Form::select(
            'icon_engine',
            $device_icon_colors,
            $item->icon_colors['engine'] ?? settings('device.status_colors.colors.engine'),
            ['class' => 'form-control'],
        ) !!}
    </div>
    ...
    @if (\Tobuli\Sensors\Types\Blocked::isEnabled())
        <div class="form-group">
            ...
            {!! Form::select(
                'icon_blocked',
                $device_icon_colors,
                $item->icon_colors['blocked'] ?? settings('device.status_colors.colors.blocked'),
                ['class' => 'form-control'],
            ) !!}
        </div>
    @endif
