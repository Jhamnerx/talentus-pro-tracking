            ...
            @if (count($device_cameras))
                @foreach ($device_cameras as $camera)
                    <tr>
                        ...
                        <td class="actions">
                            <a href="javascript:" class="btn icon edit" data-url="{!! route('device_camera.edit', $camera->id) !!}"
                                data-modal="device_camera_edit"></a>
                            <a href="javascript:" class="btn icon delete" data-url="{!! route('device_camera.do_destroy', $camera->id) !!}"
                                data-modal="device_camera_destroy"></a>
                        </td>
                    </tr>
                @endforeach
            @else
